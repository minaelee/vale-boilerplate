...
Create beautiful docmentation in under 5 minutes, using the **Fern Definition** format to define your API. Here's [an example](https://docs.propexo.com/documentation).
